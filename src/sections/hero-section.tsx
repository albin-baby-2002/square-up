...
const HeroSection = () => {
  return (
    <div
      id="home"
      className="border-gray-15 relative flex flex-col items-center justify-center gap-[40px] md:gap-[50px] border-b pt-[80px] md:pt-[112px]"
    >
      {/* patterns */}
      ...
      <div className="flex w-full flex-col items-center justify-center space-y-7 md:space-y-10">
        <h1 className="max-w-[80%] text-center text-[30px] font-semibold md:max-w-none md:text-[68px] xl:max-w-1/2">
          A Digital Product Studio that will Work
        </h1>

        <div className="text-gray-60 border-gray-15 flex items-center gap-0.5 max-w-[90%] md:gap-3 rounded-xl border bg-[#242424]/25 py-4 pr-[25px] pl-6 text-[16px] text-nowrap flex-wrap justify-center md:text-[18px]">
          <p>For</p>
          <div className="md:target-market">
            <p>Startups</p>
          </div>
          <p>,</p>
      ...
      <Image
        ...
        height={1080}
        src={"/hero-bg.svg"}
        className="absolute bottom-0 scale-[1.8] md:scale-100 left-0 -z-[1] opacity-[.9]"
      />
