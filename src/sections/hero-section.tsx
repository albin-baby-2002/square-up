  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col items-center justify-center space-y-7 md:space-y-10">
        <h1 className="max-w-[80%] text-center text-[30px] font-semibold sm:max-w-[70%] sm:text-[44px] md:max-w-[80%] md:text-[50px] lg:text-[68px] xl:max-w-1/2">
      ...
      <Image
        ...
        height={1080}
        src={"/hero-bg.svg"}
        className="absolute bottom-0 left-0 -z-[1] translate-x-[8%] scale-[3] opacity-[.9] sm:scale-[2] md:translate-x-0 md:scale-100"
      />
