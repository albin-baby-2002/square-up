...
const HeroSection = () => {
  return (
    <div className="border-gray-15 relative flex flex-col items-center justify-center space-y-[50px] border-b pt-[112px]">
      {/* patterns */}
      ...
      <div className=" absolute bottom-0 left-1/2 -translate-x-1/2 bg-gray-10 border border-gray-15 px-6 rounded-[100] py-4 translate-y-1/2">
